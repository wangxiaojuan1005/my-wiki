      ...
      <div className="page active">
        ...
        <div className="section legacy-diagnose" style={{ padding: 0, overflow: "hidden" }}>
          <div className="section-header">
            <div className="section-index" style={{ background: "#ff1f1f", boxShadow: "0 4px 10px rgba(255, 31, 31, .3)" }}>0</div>
            <div className="section-title" style={{ fontSize: "24px", fontWeight: "900", color: "#ff1f1f", transform: "translateY(2px)", margin: 0, display: "block" }}>接手时现状与问题</div>
          </div>
        ...
        <div className="section" style={{ marginBottom: "0" }}>
          <div className="section-header">
            ...
            <div className="section-title">第二板斧：划清责权边界，建立多层质量防备工程 (破解 L1 / L3)</div>
          </div>
          <div className="section-content">
            <div className="s3-grid" style={{ gridTemplateColumns: "1fr 1.3fr" }}>
              {/* Column 1: Step Boxes */}
              <div className="s3-panel" style={{ background: "#ffffff" }}>
                <div className="s3-panel-title">破案式推演边界逻辑</div>
                
                <div className="step-box">
                  <div className="step-icon"><i className="fa-solid fa-magnifying-glass"></i></div>
                  <div>
                    <div className="step-title">1. 搜集客观事实 (Fact Base)</div>
                    <div className="step-desc">提取“由于硬件原因，只能在车机运行”的核心必要边界。</div>
                  </div>
                </div>
                <div className="step-line"></div>

                <div className="step-box">
                  <div className="step-icon"><i className="fa-solid fa-arrows-split-up-and-left"></i></div>
                  <div>
                    <div className="step-title">2. 提炼部门约束条件</div>
                    <div className="step-desc">确认各下游云端团队、底层硬件团队的绝对极限瓶颈。</div>
                  </div>
                </div>
                <div className="step-line"></div>

                <div className="step-box" style={{ borderColor: "#ffb4b4", background: "#fff9f9" }}>
                  <div className="step-icon" style={{ borderColor: "#ff9999", color: "#ef4444" }}><i className="fa-solid fa-ban"></i></div>
                  <div>
                    <div className="step-title" style={{ color: "#b91c1c" }}>3. 破除与排除假性甩锅</div>
                    <div className="step-desc" style={{ color: "#7f1d1d" }}>排除类似“云端接口没测，所以APP不能断点”等伪逻辑说辞。</div>
                  </div>
                </div>
                <div className="step-line"></div>

                <div className="step-box" style={{ borderColor: "#86efac", background: "#f0fdf4" }}>
                  <div className="step-icon" style={{ borderColor: "#4ade80", color: "#16a34a" }}><i className="fa-solid fa-circle-check"></i></div>
                  <div>
                    <div className="step-title" style={{ color: "#15803d" }}>4. 收敛最终方案</div>
                    <div className="step-desc" style={{ color: "#14532d" }}>确定本侧 100% 具备控制权的核心契约，固化多层防线。</div>
                  </div>
                </div>
              </div>

              {/* Column 2: Pyramid Layer Models */}
              <div className="s3-panel" style={{ background: "#f8faff" }}>
                <div className="s3-mid-title">三层立体防死封控保障体系</div>
                
                <div className="s3-level s3-red">
                  <div className="s3-level-wrap">
                    <div className="s3-level-main">
                      <h3>第 3 层：封板 E2E 整车验收防线</h3>
                      <p>真实车机 + PO主校验</p>
                    </div>
                    <div className="s3-level-side">
                      <ul>
                        <li>非主流程不登车</li>
                        <li>下游缺陷漏损严重拒绝登车</li>
                        <li>杜绝车端低效耗时拉锯</li>
                ...
                <div className="s3-level s3-orange">
                  <div className="s3-level-wrap">
                    <div className="s3-level-main">
                      <h3>第 2 层：APP 动态集成防线 (Daily Build)</h3>
                      <p>跨团队依赖，每日集成触发</p>
                    </div>
                    <div className="s3-level-side">
                      <ul>
                ...
                <div className="s3-level s3-green">
                  <div className="s3-level-wrap">
                    <div className="s3-level-main">
                      <h3>第 1 层：APP 解耦核心自闭环验证</h3>
                      <p>自建 Mock 服务协议桩 (脫离实车)</p>
                    </div>
                    <div className="s3-level-side">
                      <ul>
                        <li><b>80%+ 问题在此彻底封堵！</b></li>
                        <li>自闭环用例，随时随地跑测</li>
                        <li>断开对车端不稳定实体卡控</li>
                      </ul>
                    </div>
                ...
                <div className="s3-bottom-box">
                  <div className="s3-bottom-title">流向治理：精细化缺陷分诊 filter</div>
                  <div className="s3-bottom-desc">
                    通过 Trace 链日志提取确凿证据 &rarr; 抛向对口责任端自行闭环并反测复盘 &rarr; APP端不包揽责任
                  </div>
                  <div className="s3-flow">
                    测试提效度：大幅削减联调被动扯皮消耗 70%↑
                  </div>
                </div>
              </div>
        ...
        <div className="section" style={{ minHeight: "auto", overflow: "visible" }}>
          <div className="section-header">
            ...
            <div className="section-title">第三板斧：提升效率 — 让测试从"人肉"到"智能"</div>
          </div>
          ...
          <div className="section-content" style={{ padding: "18px" }}>
            ...
            <div className="flow-area" style={{ marginTop: "20px" }}>
              <div className="flow-title">问题根因链路</div>

              <div className="flow-diagram">
                <svg viewBox="0 0 1323 279" preserveAspectRatio="xMidYMid meet" style={{ width: "100%", height: "100%" }}>
                  <defs>
                    <marker id="arrowBlue" markerWidth="12" markerHeight="12" refX="10" refY="6" orient="auto">
                      <path d="M0,0 L12,6 L0,12 Z" fill="var(--mck-blue)"/>
                    </marker>
                    <marker id="arrowGreen" markerWidth="12" markerHeight="12" refX="10" refY="6" orient="auto">
                      <path d="M0,0 L12,6 L0,12 Z" fill="var(--mck-teal)"/>
                    </marker>
                    <marker id="arrowDash" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto">
                      <path d="M0,0 L10,5 L0,10 Z" fill="var(--mck-blue-border)"/>
                    </marker>
                  </defs>

                  {/* Main arrows */}
                  <line x1="182" y1="103" x2="248" y2="103" stroke="var(--mck-blue)" strokeWidth="3" markerEnd="url(#arrowBlue)"/>
                  <line x1="420" y1="103" x2="468" y2="103" stroke="var(--mck-blue)" strokeWidth="3" markerEnd="url(#arrowBlue)"/>
                  <line x1="640" y1="103" x2="692" y2="103" stroke="var(--mck-blue)" strokeWidth="3" markerEnd="url(#arrowBlue)"/>
                  <line x1="860" y1="103" x2="976" y2="103" stroke="var(--mck-teal)" strokeWidth="3" markerEnd="url(#arrowGreen)"/>

                  {/* Dashed arrows down */}
                  <line x1="110" y1="136" x2="110" y2="172" stroke="var(--mck-blue-border)" strokeWidth="2.5" strokeDasharray="7 7" markerEnd="url(#arrowDash)"/>
                  <line x1="332" y1="136" x2="285" y2="172" stroke="var(--mck-blue-border)" strokeWidth="2.5" strokeDasharray="7 7"/>
                  <line x1="348" y1="136" x2="385" y2="172" stroke="var(--mck-blue-border)" strokeWidth="2.5" strokeDasharray="7 7"/>
                  <line x1="558" y1="136" x2="558" y2="172" stroke="var(--mck-blue-border)" strokeWidth="2.5" strokeDasharray="7 7" markerEnd="url(#arrowDash)"/>

                  {/* Green branch */}
                  <line x1="1080" y1="136" x2="1080" y2="182" stroke="var(--mck-teal)" strokeWidth="3"/>
                  <line x1="1080" y1="182" x2="920" y2="182" stroke="var(--mck-teal)" strokeWidth="3"/>
                  <line x1="1080" y1="182" x2="1250" y2="182" stroke="var(--mck-teal)" strokeWidth="3"/>
                  <line x1="920" y1="182" x2="920" y2="202" stroke="var(--mck-teal)" strokeWidth="3"/>
                  <line x1="1085" y1="182" x2="1085" y2="202" stroke="var(--mck-teal)" strokeWidth="3"/>
                  <line x1="1250" y1="182" x2="1250" y2="202" stroke="var(--mck-teal)" strokeWidth="3"/>
                </svg>

                {/* Top row nodes */}
                <div className="flow-node-pos" style={{ left: "2%", top: "72px", width: "13.5%", height: "62px", border: "2px solid var(--mck-blue-border)", color: "var(--mck-navy)", background: "var(--mck-blue-bg)", fontSize: "18px" }}>全量手工回归</div>
                <div className="flow-node-pos" style={{ left: "19.5%", top: "72px", width: "13.5%", height: "62px", border: "2px solid var(--mck-blue-border)", color: "var(--mck-navy)", background: "var(--mck-blue-bg)", fontSize: "18px" }}>无分层策略</div>
                <div className="flow-node-pos" style={{ left: "36%", top: "72px", width: "13.5%", height: "62px", border: "2px solid var(--mck-blue-border)", color: "var(--mck-navy)", background: "var(--mck-blue-bg)", fontSize: "18px" }}>端到端硬扛</div>
                <div className="flow-node-pos" style={{ left: "53.5%", top: "72px", width: "13.5%", height: "62px", border: "2px solid var(--mck-terracotta)", color: "var(--mck-terracotta)", background: "var(--mck-terracotta-bg)", fontSize: "18px" }}>效率锁死</div>
                <div className="flow-node-pos" style={{ left: "75%", top: "72px", width: "13.5%", height: "62px", border: "2px solid var(--mck-teal)", color: "var(--mck-teal)", background: "var(--mck-teal-bg)", fontSize: "18px" }}>破局方向</div>

                {/* Bottom row nodes */}
                <div className="flow-node-pos" style={{ left: "2%", top: "175px", width: "21%", height: "58px", border: "1.5px solid var(--mck-blue-border)", color: "var(--mck-navy)", background: "#ffffff", fontSize: "14px", fontWeight: 600 }}>
                  Feature / DailyBuild / 封板<br />三轮测试
                </div>
                <div className="flow-node-pos" style={{ left: "27%", top: "175px", width: "21%", height: "58px", border: "1.5px solid var(--mck-blue-border)", color: "var(--mck-navy)", background: "#ffffff", fontSize: "14px", fontWeight: 600 }}>
                  依赖实车 ｜ 无 Mock ｜ 无自动化
                </div>
                <div className="flow-node-pos" style={{ left: "64.5%", top: "172px", width: "10.5%", height: "74px", border: "2px solid var(--mck-teal)", color: "var(--mck-teal)", background: "var(--mck-teal-bg)", fontSize: "14px" }}>UI 自动化<br />减少手工</div>
                <div className="flow-node-pos" style={{ left: "76.5%", top: "172px", width: "10.5%", height: "74px", border: "2px solid var(--mck-teal)", color: "var(--mck-teal)", background: "var(--mck-teal-bg)", fontSize: "14px" }}>Mock<br />解除硬依赖</div>
                <div className="flow-node-pos" style={{ left: "89%", top: "172px", width: "10%", height: "74px", border: "2px solid var(--mck-teal)", color: "var(--mck-teal)", background: "var(--mck-teal-bg)", fontSize: "14px" }}>分层策略<br />精准投入</div>
              </div>
            </div>
